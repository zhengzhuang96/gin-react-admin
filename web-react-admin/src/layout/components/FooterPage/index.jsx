    ...
    <>
      <div className={styles.box}>
        <div className="ant-pro-global-footer-links">
          <Space>
            <a title="Ant Design Pro" target="_blank" href="https://github.com/zhengzhuang96/gin-react-admin">Gin React Admin</a>
            ...
            <a title="Ant Design" target="_blank" href="https://github.com/zhengzhuang96">ZhengZhuang</a>
          </Space>
        </div>
