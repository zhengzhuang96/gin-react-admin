    ...
    <>
      <div className={styles.box}>
        <div className="ant-pro-global-footer-links">
          <Space>
            <a title="Ant Design Pro" target="_blank" href="https://github.com/zhengzhuang96/gin-react-admin" rel="noopener noreferrer">Gin React Admin</a>
            ...
            <a title="Ant Design" target="_blank" href="https://github.com/zhengzhuang96" rel="noopener noreferrer">ZhengZhuang</a>
          </Space>
        </div>
        <div className="ant-pro-global-footer-copyright">
          <span role="img" aria-label="copyright" className="anticon anticon-copyright">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="copyright" width="1em" height="1em" fill="currentColor" aria-hidden="true">
